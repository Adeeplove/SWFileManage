...
public class ResTableTypeInfoChunk extends BaseTypeChunk {
    ...
    public static ResTableTypeInfoChunk parseFrom(RandomInputStream.CutStream stream, ResStringPoolChunk stringChunk) throws IOException {
        ...
        chunk.entriesStart = IUtils.readIntLow(stream);
        ...
        for (int i = 0; i < chunk.entryCount; ++i) {
            chunk.entryOffsets[i] = IUtils.readIntLow(stream);
        }
        // read entry

...
public class IGlideModule extends AppGlideModule {
    ...
    public void registerComponents(@NonNull Context context, @NonNull Glide glide, @NonNull Registry registry) {
        registry.prepend(ManageFile.class, Bitmap.class, new ApkModelLoader.Factory(context));
        registry.prepend(ManageFile.class, Bitmap.class, new DataDirModelLoader.Factory(context));
    }
